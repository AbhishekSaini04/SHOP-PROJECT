...
const {duplicateElementRemover}=require("../controller/duplicateElementRemover");
...
router.get("/dashboard/uploadedProducts",restrictTo(["ADMIN"]),async(req,res)=>{
...
router.get("/dashboard/updateProduct/:id",restrictTo(["ADMIN"]),(req,res)=>{
   
    return res.render("dashboard/addproduct",{condition:false,id:req.params.id});
});
...
router.get("/dashboard/updateblog/:id",restrictTo(["ADMIN"]),(req,res)=>{
    ...
    return res.render("dashboard/addblog",{condition:false,id:req.params.id});
});

//all uploaded blog
router.get("/dashboard/uploadedBlogs",restrictTo(["ADMIN"]),async(req,res)=>{
